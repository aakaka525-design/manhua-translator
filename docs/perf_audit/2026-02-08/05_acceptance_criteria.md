...
- Tail optimization required follow-up at this checkpoint; next single-variable candidate was lowering `AI_TRANSLATE_MAX_INFLIGHT_CALLS` to 1 and re-running the same S6 workload.
